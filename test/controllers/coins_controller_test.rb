...
class CoinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coin" do
    assert_difference('Coin.count') do
      post coins_url, params: { coin: { acronym: @coin.acronym, decription: @coin.decription, url_image: @coin.url_image } }
    end
  ...
  test "should update coin" do
    patch coin_url(@coin), params: { coin: { acronym: @coin.acronym, decription: @coin.decription, url_image: @coin.url_image } }
